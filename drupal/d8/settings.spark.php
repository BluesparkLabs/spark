...
// The SPARK_PHP environment variable is set in the D8 Docker Compose file for the
// PHP container. That's how we know if PHP is being executed in the container or
